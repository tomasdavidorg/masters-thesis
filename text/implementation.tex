...
% decribe how application works
\section{Application implementation}

\subsection{Vehicle Routing problem}

\paragraph{Score calculator} % easy java score calculator
\paragraph{Algorithms}%xml configs
\paragraph{Vehicle routing importer}
\paragraph{Domains}%vehicle customer ... planing entity planing value...
