...
\projectinfo{
  ...
  %===========================================================================
  %Klicova slova
  keywords.cs={OptaPlanner, Android, portace, Java SE}, %klicova slova v ceskem jazyce
  keywords.en={OptaPlanner, Android, port, Java SE}, %klicova slova v anglickem jazyce
  %Abstract
  abstract.cs={Tato práce se zabývá nástrojem OptaPlanner, který se využívá pro řešení plánovacích problémů. Dále je v práci popsána platforma Android -- operační systém určený pro mobilní zařízení. V poslední řadě ze zabývá problémy spojené s portací nástroje OptaPlanner na tuto platformu.}, % abstrakt v ceskem jazyce
  abstract.en={This thesis deals with OptaPlanner tool, which is used for solving optimization problems. This work describes Android platform -- an operating system for mobile devices. Finally, it deals with problems related to port of OptaPlanner on this platform.}, % abstrakt v anglickem jazyce
  %Prohlaseni
